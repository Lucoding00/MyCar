...
<script>
    layui.use(['table', 'jquery', 'layer', 'form'], function () {
        ...
        //表格头工具栏监听事件，在表格里面的设置这个toolbar，然后来监听这个事件得到这个事件的一个名称
        ...
        function add() {
            ...
            let layOps = {
                ...
                type: 1,
                /*内容的一个html文本，然后将内容放到这个地方，放到content里面*/
                content: $("#addUserTpl").html(),
                area: ['680px', '450px'],
                success: function (layero, index) {
                    /*渲染这个radio按钮*/
                    form.render("radio");
                    //表单的提交监听subBtnFilter，这个过滤器时候的监听事件得到之后的结果
